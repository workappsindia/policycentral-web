  ...
  <ul class="nav-links">
    ...
    <li class="nav-item">
      ...
      <div class="dropdown dw">
        ...
        <a href="<?php echo esc_url(home_url('/use-cases/retail-operations/')); ?>" class="di"><div class="di-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg></div><div><div class="di-title">Retail Operations</div><div class="di-sub">Stores, partners &amp; vendor circulars</div></div></a>
