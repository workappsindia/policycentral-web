...
<div class="nav-inner">
  ...
  <ul class="nav-links">
    ...
    <li class="nav-item">
      <a href="<?php echo esc_url(home_url('/use-cases/')); ?>" class="nav-link">Use Cases<svg class="nav-chevron" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round"><polyline points="4 6 8 10 12 6"/></svg></a>
      <div class="dropdown dw">
        <a href="<?php echo esc_url(home_url('/use-cases/policy-management/')); ?>" class="di"><div class="di-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg></div><div><div class="di-title">Policy Management</div><div class="di-sub">Host, version &amp; distribute policies</div></div></a>
        <a href="<?php echo esc_url(home_url('/use-cases/corporate-updates/')); ?>" class="di"><div class="di-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="2"/><line x1="3" y1="9" x2="21" y2="9"/><line x1="9" y1="21" x2="9" y2="9"/></svg></div><div><div class="di-title">Corporate Updates</div><div class="di-sub">Leadership &amp; board communications</div></div></a>
        <a href="<?php echo esc_url(home_url('/use-cases/product-information/')); ?>" class="di"><div class="di-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="3" width="20" height="14" rx="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/></svg></div><div><div class="di-title">Product Information</div><div class="di-sub">Product docs &amp; guidelines</div></div></a>
        <a href="<?php echo esc_url(home_url('/use-cases/sops/')); ?>" class="di"><div class="di-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="9 11 12 14 22 4"/><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"/></svg></div><div><div class="di-title">SOPs</div><div class="di-sub">Standardised operating procedures</div></div></a>
        <a href="<?php echo esc_url(home_url('/use-cases/branch-circulars/')); ?>" class="di"><div class="di-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg></div><div><div class="di-title">Branch Circulars</div><div class="di-sub">Region &amp; branch-level notices</div></div></a>
        <a href="<?php echo esc_url(home_url('/use-cases/business-requirement-docs/')); ?>" class="di"><div class="di-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="7" width="20" height="14" rx="2"/><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"/></svg></div><div><div class="di-title">Business Req. Docs</div><div class="di-sub">BRDs, specs &amp; project docs</div></div></a>
        <a href="<?php echo esc_url(home_url('/use-cases/hr-employee-governance/')); ?>" class="di"><div class="di-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg></div><div><div class="di-title">HR &amp; Employee Governance</div><div class="di-sub">Handbooks, forms &amp; POSH training</div></div></a>
        <a href="<?php echo esc_url(home_url('/use-cases/compliance-legal/')); ?>" class="di"><div class="di-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 21h18M3 10h18M5 6l7-3 7 3M4 10v11M20 10v11"/></svg></div><div><div class="di-title">Compliance &amp; Legal</div><div class="di-sub">SEBI, KYC &amp; distributor cascade</div></div></a>
        <a href="<?php echo esc_url(home_url('/use-cases/it-security/')); ?>" class="di"><div class="di-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="11" width="18" height="11" rx="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg></div><div><div class="di-title">IT &amp; Security</div><div class="di-sub">Role-bounded access &amp; audit trail</div></div></a>
      </div>
    </li>
    <li class="nav-item">
      <a href="<?php echo esc_url(home_url('/industries/')); ?>" class="nav-link">Industries<svg class="nav-chevron" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round"><polyline points="4 6 8 10 12 6"/></svg></a>
      <div class="dropdown">
        <a href="<?php echo esc_url(home_url('/industries/pharma-healthcare/')); ?>" class="di"><div class="di-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M19 8h-4V4a2 2 0 0 0-2-2h-2a2 2 0 0 0-2 2v4H5a2 2 0 0 0-2 2v2a2 2 0 0 0 2 2h4v4a2 2 0 0 0 2 2h2a2 2 0 0 0 2-2v-4h4a2 2 0 0 0 2-2v-2a2 2 0 0 0-2-2z"/></svg></div><div><div class="di-title">Pharma &amp; Healthcare</div><div class="di-sub">21 CFR Part 11-ready document control</div></div></a>
        <a href="<?php echo esc_url(home_url('/industries/retail/')); ?>" class="di"><div class="di-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg></div><div><div class="di-title">Retail</div><div class="di-sub">Stores, partners &amp; vendor circulars</div></div></a>
        <a href="<?php echo esc_url(home_url('/industries/education/')); ?>" class="di"><div class="di-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M22 10L12 5 2 10l10 5 10-5z"/><path d="M6 12v5c0 1 2.5 3 6 3s6-2 6-3v-5"/></svg></div><div><div class="di-title">Education</div><div class="di-sub">Living, searchable document library</div></div></a>
      </div>
    </li>
    <li class="nav-item">
    ...
    <li class="nav-item">
      ...
      <div class="dropdown">
        <a href="<?php echo esc_url(home_url('/team/')); ?>" class="di"><div class="di-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/></svg></div><div><div class="di-title">Team</div><div class="di-sub">The people behind PolicyCentral.ai</div></div></a>
    ...
    <li class="nav-item">
      ...
      <div class="dropdown dw">
        ...
        <a href="<?php echo esc_url(home_url('/policies/')); ?>" class="di"><div class="di-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><path d="M9 13h6"/><path d="M9 17h4"/></svg></div><div><div class="di-title">Policies</div><div class="di-sub">Free, adaptable policy templates</div></div></a>
        <a href="<?php echo esc_url(home_url('/compliance/')); ?>" class="di"><div class="di-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 21h18M3 10h18M5 6l7-3 7 3M4 10v11M20 10v11"/></svg></div><div><div class="di-title">Compliance</div><div class="di-sub">Decoded RBI rules &amp; enforcement tracker</div></div></a>
      </div>
    </li>
  ...
  <div class="nav-right">
    <a href="<?php echo esc_url(home_url('/search/')); ?>" class="nav-search-btn" aria-label="Search PolicyGPT">
