...
<div class="container">
  <div class="faq-tag">About Us</div>
...
<div class="cat-grid">
  ...
  <a href="https://workapps.com" target="_blank" class="cat-card reveal rd3">
    <div class="cat-emoji"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/images/workapps-logo.jpeg" alt="WorkApps" style="height:36px;width:auto;border-radius:6px"></div>
    <h3>WorkApps</h3>
  ...
  <a href="https://videocx.io" target="_blank" class="cat-card reveal rd4">
    <div class="cat-emoji"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/images/VideoCX-io-logo.svg" alt="VideoCX.io" style="height:14px;width:auto"></div>
    <h3>VideoCX.io</h3>
