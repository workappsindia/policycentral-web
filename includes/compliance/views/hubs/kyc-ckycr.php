    ...
    <div class="hub-hero-r reveal rd2">
      <div class="snap">
        ...
        <div class="snap-body">
          ...
          <div class="snap-row"><span class="snap-k">Actions in tracker</span><span class="snap-v"><?php echo (int) $kyc_total; ?><small>banks, NBFCs &amp; payment firms</small></span></div>
        </div>
      </div>
    </div>
  </div>
...
<div class="container">
  ...
  <div style="margin-top:48px">
    ...
    <div class="obl-grid">
      ...
      <div class="obl reveal rd1"><div class="obl-num">Risk review</div><h4>Re-categorise every six months</h4><p>Risk categorisation of accounts must be reviewed <b>at least once in every six months</b>, the single most-penalised KYC obligation in FY26-27 so far.</p></div>
      ...
      <div class="obl reveal"><div class="obl-num">CKYCR</div><h4>File records with the registry</h4><p>Customers' KYC records must be uploaded to the <b>Central KYC Records Registry</b> within the prescribed timeline and kept current, missed uploads keep drawing penalties.</p></div>
...
<div class="container">
  ...
  <p class="pat-lead"><?php echo (int) $kyc_total; ?> of the actions in our tracker cite KYC failures, and none of them are comprehension gaps. A registry upload that didn't happen on time, beneficial owners never identified, a six-month review cycle that stopped running, video KYC missing its required face-matching component, the obligation was known; the operational loop behind it broke. The actions below are drawn from RBI press releases.</p>
...
<div class="container">
  <div class="section-header">
    ...
    <p>Every cited failure above is a procedure that existed on paper and broke in a branch, a back office, or a system handover. Here's an honest split of what a policy distribution-and-attestation layer like PolicyCentral.ai does and does not address.</p>
  </div>
...
<div class="container">
  <div class="cv-inner">
    ...
    <div class="cv-card buyer reveal rd1">
      ...
      <p>PolicyCentral.ai shows you, live and branch-by-branch, exactly who has read and acknowledged each KYC procedure and every update, with a tamper-evident trail you can export for an RBI review. Walk through it on your own data.</p>
