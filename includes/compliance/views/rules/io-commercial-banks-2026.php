<?php
/**
 * Decode: RBI (Commercial Banks - Internal Ombudsman) Directions, 2026
 * /compliance/rules/io-commercial-banks-2026   (rbi_rule single)
 *
 * Verified against the RBI notification id=13271 (RBI/CEPD/2025-26/381),
 * 14 Jan 2026. See compliance-build/research/2026-io-directions-verified.md.
 * Obligations are described thematically, NO unverified 2026 clause numbers.
 */
defined('ABSPATH') || exit;

$rbi_url  = 'https://www.rbi.org.in/Scripts/BS_ViewMasDirections.aspx?id=13271';
...
<div class="container">
  <div class="rh-inner">
    <h1>RBI <span class="g-text">(Commercial Banks - Internal Ombudsman)</span> Directions, 2026</h1>
    <p class="lede">The 2026 Direction requiring larger commercial banks to maintain an independent, apex-level Internal Ombudsman, and to escalate every rejected customer complaint to it before the customer is sent to the RBI Ombudsman. One of six entity-class Directions that replaced the 2023 Master Direction on 14 January 2026.</p>
    ...
    <?php pcc_breadcrumb(array(array('label' => 'Compliance Intelligence', 'url' => home_url('/compliance/')), array('label' => 'Rule Library', 'url' => home_url('/compliance/rules/')), array('label' => 'Commercial Banks IO Directions, 2026'))); ?>
  </div>
</div>
</section>
  ...
  <main class="body-col">
    <div class="metabox">
      ...
      <div class="metabox-body">
        <div class="metabox-row"><span class="k">Instrument</span><span class="v">RBI/CEPD/2025-26/381</span></div>
        ...
        <div class="metabox-row"><span class="k">Issued by</span><span class="v">RBI · CEPD</span></div>
        <div class="metabox-row"><span class="k">Applies to</span><span class="v">Commercial banks · 10+ outlets</span></div>
    ...
    <section class="sec" id="summary">
      <div class="tldr">
        ...
        <p>If a covered bank rejects a customer complaint, that rejection must be reviewed by an <strong>independent Internal Ombudsman inside the bank</strong> before the customer is told to approach the RBI Ombudsman, and the bank must be able to show it has the system, the people and the staff awareness to make that happen reliably.</p>
      </div>
      <p>On 14 January 2026 the RBI replaced its single 2023 Internal Ombudsman Master Direction with <strong>six entity-class-specific Directions</strong>. This one applies to commercial banks. It carries forward the core Internal Ombudsman architecture, auto-escalation of rejected complaints, independent reasoned decisions binding on the bank, and Board oversight, while pinning applicability to a fixed measurement date and tightening reporting.</p>
    </section>

    <section class="sec" id="applies">
      <div class="sec-eyebrow"><span>Scope</span></div>
      <h2>Who it applies to</h2>
      <p>The Direction binds larger commercial banks measured at a fixed date. If you are below the threshold today, monitor your outlet count, crossing it starts a clock.</p>
      <ul class="applies">
        <li><span class="chk"><svg viewBox="0 0 12 12" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="2 6 5 9 10 3"/></svg></span><span><b>Commercial banks with 10 or more banking outlets in India as on 31 March 2025</b>, whether incorporated in India or abroad, including the State Bank of India and the corresponding new banks.</span></li>
        <li><span class="chk"><svg viewBox="0 0 12 12" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="2 6 5 9 10 3"/></svg></span><span><b>Excludes</b> Small Finance Banks, Payments Banks and Local Area Banks, each covered by its own 2026 Direction, and any bank in resolution, winding up or under directions.</span></li>
        <li><span class="chk"><svg viewBox="0 0 12 12" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="2 6 5 9 10 3"/></svg></span><span>A bank meeting the criteria <b>after 31 March 2025</b> must comply within <b>six months</b> of doing so.</span></li>
      </ul>
      <div class="note-row">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>
        <span>Small Finance Banks and Payments Banks have their own parallel 2026 IO Directions, this decode covers commercial banks only.</span>
      </div>
    </section>
    ...
    <section class="sec" id="background">
      ...
      <ul class="lineage">
        ...
        <li class="now"><span class="yr">14 Jan 2026</span><b>Six entity-class Directions, 2026</b>, this Commercial Banks Direction is one of them.</li>
      </ul>
    </section>
    ...
    <div class="opcallout">
      ...
      <div class="opcallout-t"><h3>Knowing the rule is step one</h3><p>See how banks distribute the IO SOP across every branch and prove who acknowledged it.</p></div>
    ...
    <section class="sec" id="source" style="margin-top:48px">
      <div class="srcbox">
        ...
        <div class="src-row"><span class="k">Title</span><span class="v">RBI (Commercial Banks - Internal Ombudsman) Directions, 2026</span></div>
        <div class="src-row"><span class="k">Reference no.</span><span class="v">RBI/CEPD/2025-26/381</span></div>
