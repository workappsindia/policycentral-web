  ...
  <main class="body-col">
    ...
    <section class="sec" id="changed">
      ...
      <ul class="applies">
        ...
        <li><span class="chk"><svg viewBox="0 0 12 12" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="2 6 5 9 10 3"/></svg></span><span>Several paragraphs are <b>omitted</b> (for Commercial Banks: Para 7(1)–(2), 8, 59–61), and 52, 58 and 62 are substituted with the agency/referral rules above.</span></li>
