 ...
 * (RBI/2026-27/115, s.35A Banking Regulation Act 1949), paragraphs 85A to 85ZA
 ...
 * for NBFCs/HFCs the identical obligations sit at paragraphs 101A to 101ZA of the
  ...
  <main class="body-col">
    ...
    <section class="sec" id="applies">
      ...
      <ul class="applies">
        ...
        <li><span class="chk"><svg viewBox="0 0 12 12" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="2 6 5 9 10 3"/></svg></span><span><b>Housing Finance Companies</b>, which RBI folds straight into the NBFC framework: an HFC must comply with paragraphs 101A to 101ZA of the NBFC RBC Directions, 2025.</span></li>
      </ul>
      <div class="note-row">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>
        <span>For banks the rules land at paragraphs <b>85A to 85ZA</b>; for NBFCs and HFCs the identical set sits at paragraphs <b>101A to 101ZA</b>. The obligations below are common to all.</span>
      </div>
    </section>
    ...
    <section class="sec" id="obligations">
      ...
      <div class="obgroup">
        <div class="obgroup-head"><div class="ib ib-teal"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg></div><h3>A Board-approved policy (Para 85A to 85B)</h3></div>
      ...
      <div class="obgroup">
        <div class="obgroup-head"><div class="ib ib-violet"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/></svg></div><h3>Direct Selling / Marketing Agents (Para 85C to 85F, 85O)</h3></div>
        <div class="obgroup-body">
      ...
      <div class="obgroup">
        <div class="obgroup-head"><div class="ib ib-em"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="9 11 12 14 22 4"/><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"/></svg></div><h3>Consent &amp; disclosure (Para 85G to 85I)</h3></div>
        <div class="obgroup-body">
      ...
      <div class="obgroup">
        <div class="obgroup-head"><div class="ib ib-teal"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 11l18-5v12L3 14v-3z"/><path d="M11.6 16.8a3 3 0 1 1-5.8-1.6"/></svg></div><h3>Advertising, marketing &amp; agent conduct (Para 85J to 85N)</h3></div>
        <div class="obgroup-body">
      ...
      <div class="obgroup">
        <div class="obgroup-head"><div class="ib ib-violet"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 11l3 3L22 4"/><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"/></svg></div><h3>Suitability &amp; documentation (Para 85P to 85T)</h3></div>
        <div class="obgroup-body">
          <div class="obrow"><div class="otxt"><h4>Assess suitability before selling</h4><p>Except for products the policy treats as suitable for everyone, suitability and appropriateness must be assessed: product features, risk-return, horizon, complexity and fees, weighed against the customer's age, income, financial literacy and risk tolerance, using any regulator-prescribed assessment.</p></div></div>
      ...
      <div class="obgroup">
        <div class="obgroup-head"><div class="ib ib-em"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M10.29 3.86 1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg></div><h3>Preventing mis-selling (Para 85U to 85X)</h3></div>
        <div class="obgroup-body">
      ...
      <div class="obgroup">
        <div class="obgroup-head"><div class="ib ib-teal"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg></div><h3>Feedback &amp; redress (Para 85Y to 85Z)</h3></div>
        <div class="obgroup-body">
    ...
    <section class="sec" id="changed">
      ...
      <ul class="applies">
        <li><span class="chk"><svg viewBox="0 0 12 12" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="2 6 5 9 10 3"/></svg></span><span>Advertising, marketing and sale rules, previously sitting under the <b>Undertaking of Financial Services Directions, 2025</b>, are now <b>consolidated into the RBC Directions</b> as a new section (Para 85A to 85ZA for banks).</span></li>
    ...
    <section class="sec" id="source" style="margin-top:48px">
      <div class="srcbox">
        ...
        <div class="disc-line">
          ...
          <span>This is a plain-language summary to aid understanding, not legal advice. Clause numbers cited are the Commercial Banks numbering; NBFCs/HFCs carry the same obligations at paragraphs 101A to 101ZA. RBI instruments are amended over time, always verify against the original on rbi.org.in and consult your compliance and legal teams before acting.</span>
        </div>
      </div>
    </section>
  </main>
