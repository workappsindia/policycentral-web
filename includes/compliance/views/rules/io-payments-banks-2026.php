<?php
/**
 * Decode: RBI (Payments Banks - Internal Ombudsman) Directions, 2026
 * /compliance/rules/io-payments-banks-2026   (rbi_rule single)
 *
 * Verified against the RBI notification id=13273 (RBI/CEPD/2025-26/383),
 * 14 Jan 2026, issued under s. 35A of the Banking Regulation Act, 1949. See
 * compliance-build/research/2026-io-directions-verified.md (§D, 2026-06-12).
 * Obligations are described thematically, NO unverified 2026 clause numbers.
 */
defined('ABSPATH') || exit;

$rbi_url  = 'https://www.rbi.org.in/Scripts/BS_ViewMasDirections.aspx?id=13273';
...
<div class="container">
  <div class="rh-inner">
    <h1>RBI <span class="g-text">(Payments Banks - Internal Ombudsman)</span> Directions, 2026</h1>
    <p class="lede">The 2026 Direction requiring larger Payments Banks to maintain an independent Internal Ombudsman and escalate every rejected customer complaint to it before the customer reaches the RBI Ombudsman. Issued under section 35A of the Banking Regulation Act, 1949, one of six entity-class Directions that replaced the 2023 Master Direction on 14 January 2026.</p>
    ...
    <?php pcc_breadcrumb(array(array('label' => 'Compliance Intelligence', 'url' => home_url('/compliance/')), array('label' => 'Rule Library', 'url' => home_url('/compliance/rules/')), array('label' => 'Payments Banks IO Directions, 2026'))); ?>
  </div>
</div>
</section>
  ...
  <main class="body-col">
    <div class="metabox">
      ...
      <div class="metabox-body">
        <div class="metabox-row"><span class="k">Instrument</span><span class="v">RBI/CEPD/2025-26/383</span></div>
        ...
        <div class="metabox-row"><span class="k">Power</span><span class="v">s. 35A, Banking Regulation Act</span></div>
        <div class="metabox-row"><span class="k">Applies to</span><span class="v">Payments Banks, 10+ outlets</span></div>
    ...
    <section class="sec" id="summary">
      <div class="tldr">
        ...
        <p>If a covered Payments Bank rejects a customer complaint, that rejection must be reviewed by an <strong>independent Internal Ombudsman inside the bank</strong> before the customer is told to approach the RBI Ombudsman, and the bank must be able to show the system, people and staff awareness to make that happen reliably.</p>
      </div>
      <p>On 14 January 2026 the RBI replaced its single 2023 Internal Ombudsman Master Direction with <strong>six entity-class-specific Directions</strong>. This one applies to Payments Banks. The core architecture is unchanged: auto-escalation of rejected complaints, binding reasoned decisions, and Board oversight, applied to a class whose complaint volumes are dominated by digital-channel transactions.</p>
    </section>

    <section class="sec" id="applies">
      <div class="sec-eyebrow"><span>Scope</span></div>
      <h2>Who it applies to</h2>
      <p>Applicability is measured as on 31 March 2025, against a single size threshold.</p>
      <ul class="applies">
        <li><span class="chk"><svg viewBox="0 0 12 12" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="2 6 5 9 10 3"/></svg></span><span><b>Payments Banks</b> with <b>10 or more banking outlets in India</b> as on 31 March 2025. A "banking outlet" is the fixed-point service delivery unit defined in the RBI (Payments Banks – Branch Authorisation) Directions, 2025.</span></li>
        <li><span class="chk"><svg viewBox="0 0 12 12" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="2 6 5 9 10 3"/></svg></span><span>A Payments Bank crossing the threshold <b>after 31 March 2025</b> must comply within <b>six months</b> of meeting it.</span></li>
        <li><span class="chk"><svg viewBox="0 0 12 12" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="2 6 5 9 10 3"/></svg></span><span>Other bank classes are <b>not</b> under this Direction: commercial banks and Small Finance Banks each have their own 2026 Direction.</span></li>
      </ul>
    </section>
    ...
    <section class="sec" id="obligations">
      ...
      <div class="obgroup">
        ...
        <div class="obgroup-body">
          <div class="obrow"><div class="otxt"><h4>An independent Internal Ombudsman</h4><p>An IO appointed for a fixed contractual term, independent of the bank, sitting at the apex of the grievance-redress mechanism and reporting functionally to the Board. A Deputy IO may be appointed where complaint volume warrants.</p></div></div>
        </div>
      </div>
      ...
      <div class="obgroup">
        ...
        <div class="obgroup-body">
          ...
          <div class="obrow"><div class="otxt"><h4>30-day final decision</h4><p>The final decision must reach the complainant within <b>30 days</b> of the bank first receiving the complaint.</p></div></div>
          <div class="obrow"><div class="otxt"><h4>Binding decisions &amp; the customer's next step</h4><p>The IO's decision binds the bank unless the competent authority formally disagrees through a narrow Board-level route. Where a complaint is still rejected after IO review, the bank must inform the customer of their right to approach the RBI Ombudsman.</p></div></div>
        </div>
      </div>
    ...
    <section class="sec" id="changed">
      ...
      <ul class="applies">
        <li><span class="chk"><svg viewBox="0 0 12 12" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="2 6 5 9 10 3"/></svg></span><span>The single 2023 Master Direction was <b>repealed</b> and split into <b>six entity-class Directions</b>; Payments Banks now have <b>their own</b>. Existing IO appointments continue under it.</span></li>
        <li><span class="chk"><svg viewBox="0 0 12 12" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="2 6 5 9 10 3"/></svg></span><span>Applicability is now anchored to branches <b>as on 31 March 2025</b>, with the "banking outlet" yardstick tied to the Payments Banks Branch Authorisation Directions, 2025.</span></li>
    ...
    <section class="sec" id="penalised">
      ...
      <?php $pen = pcc_render_penalised_for_rule('io-payments-banks-2026'); ?>
      <?php if ($pen) : ?>
      ...
      <?php else : ?>
      <p>No FY25-26 action in our tracker cites a Payments Bank's Internal Ombudsman framework so far, the IO-related penalties this year landed on commercial banks and NBFCs. The obligation set is the same, which makes their cited failures the playbook of what supervisors check.</p>
      <?php endif; ?>
    ...
    <section class="sec" id="background">
      ...
      <ul class="lineage">
        ...
        <li class="now"><span class="yr">14 Jan 2026</span><b>Six entity-class Directions, 2026</b>, this Payments Banks Direction is one of them.</li>
      </ul>
    </section>
    ...
    <div class="opcallout">
      ...
      <div class="opcallout-t"><h3>Knowing the rule is step one</h3><p>See how banks distribute the IO SOP across every outlet and prove who acknowledged it.</p></div>
    ...
    <section class="sec" id="source" style="margin-top:48px">
      <div class="srcbox">
        ...
        <div class="src-row"><span class="k">Title</span><span class="v">RBI (Payments Banks - Internal Ombudsman) Directions, 2026</span></div>
        <div class="src-row"><span class="k">Reference no.</span><span class="v">RBI/CEPD/2025-26/383</span></div>
