<?php
/**
 * Decode: RBI (Small Finance Banks - Internal Ombudsman) Directions, 2026
 * /compliance/rules/io-sfb-2026   (rbi_rule single)
 *
 * Verified against the RBI notification id=13272 (RBI/CEPD/2025-26/382),
 * 14 Jan 2026, issued under s. 35A of the Banking Regulation Act, 1949. See
 * compliance-build/research/2026-io-directions-verified.md (§C, 2026-06-12).
 * Obligations are described thematically, NO unverified 2026 clause numbers.
 */
defined('ABSPATH') || exit;

$rbi_url  = 'https://www.rbi.org.in/Scripts/BS_ViewMasDirections.aspx?id=13272';
...
<div class="container">
  <div class="rh-inner">
    <h1>RBI <span class="g-text">(Small Finance Banks - Internal Ombudsman)</span> Directions, 2026</h1>
    ...
    <?php pcc_breadcrumb(array(array('label' => 'Compliance Intelligence', 'url' => home_url('/compliance/')), array('label' => 'Rule Library', 'url' => home_url('/compliance/rules/')), array('label' => 'SFB IO Directions, 2026'))); ?>
  </div>
</div>
</section>
  ...
  <main class="body-col">
    <div class="metabox">
      ...
      <div class="metabox-body">
        <div class="metabox-row"><span class="k">Instrument</span><span class="v">RBI/CEPD/2025-26/382</span></div>
        ...
        <div class="metabox-row"><span class="k">Applies to</span><span class="v">SFBs, 10+ banking outlets</span></div>
    ...
    <section class="sec" id="summary">
      <div class="tldr">
        ...
        <p>If a covered Small Finance Bank rejects a customer complaint, that rejection must be reviewed by an <strong>independent Internal Ombudsman inside the bank</strong> before the customer is told to approach the RBI Ombudsman, and the bank must be able to show the system, people and staff awareness to make that happen reliably.</p>
      </div>
      <p>On 14 January 2026 the RBI replaced its single 2023 Internal Ombudsman Master Direction with <strong>six entity-class-specific Directions</strong>. This one applies to Small Finance Banks, which were previously covered alongside other banks and now have a Direction of their own. The core architecture is unchanged: auto-escalation of rejected complaints, binding reasoned decisions, and Board oversight.</p>
    </section>
    ...
    <section class="sec" id="applies">
      ...
      <ul class="applies">
        <li><span class="chk"><svg viewBox="0 0 12 12" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="2 6 5 9 10 3"/></svg></span><span><b>Small Finance Banks</b> with <b>10 or more banking outlets in India</b> as on 31 March 2025.</span></li>
        <li><span class="chk"><svg viewBox="0 0 12 12" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="2 6 5 9 10 3"/></svg></span><span>An SFB crossing the 10-outlet threshold <b>after 31 March 2025</b> must comply within <b>six months</b> of meeting it.</span></li>
        <li><span class="chk"><svg viewBox="0 0 12 12" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="2 6 5 9 10 3"/></svg></span><span>Other bank classes are <b>not</b> under this Direction: commercial banks, Payments Banks and Local Area Banks each have their own 2026 Direction (or fall outside the framework).</span></li>
      </ul>
    </section>
    ...
    <section class="sec" id="changed">
      ...
      <ul class="applies">
        <li><span class="chk"><svg viewBox="0 0 12 12" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="2 6 5 9 10 3"/></svg></span><span>The single 2023 Master Direction was <b>repealed</b> and split into <b>six entity-class Directions</b>; SFBs now have <b>their own</b>. Existing IO appointments continue under it.</span></li>
        <li><span class="chk"><svg viewBox="0 0 12 12" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="2 6 5 9 10 3"/></svg></span><span>Applicability is now anchored to branches <b>as on 31 March 2025</b>, with a six-month runway for SFBs that cross the threshold later.</span></li>
    ...
    <section class="sec" id="penalised">
      ...
      <?php $pen = pcc_render_penalised_for_rule('io-sfb-2026'); ?>
      <?php if ($pen) : ?>
      ...
      <?php else : ?>
      <p>No FY25-26 action in our tracker cites a Small Finance Bank's Internal Ombudsman framework so far, the IO-related penalties this year landed on commercial banks and NBFCs. The obligation set is the same, which makes their cited failures the playbook of what supervisors check.</p>
      <?php endif; ?>
    ...
    <section class="sec" id="background">
      ...
      <ul class="lineage">
        ...
        <li class="now"><span class="yr">14 Jan 2026</span><b>Six entity-class Directions, 2026</b>, this SFB Direction is one of them.</li>
      </ul>
    </section>
    ...
    <section class="sec" id="source" style="margin-top:48px">
      <div class="srcbox">
        ...
        <div class="src-row"><span class="k">Title</span><span class="v">RBI (Small Finance Banks - Internal Ombudsman) Directions, 2026</span></div>
        <div class="src-row"><span class="k">Reference no.</span><span class="v">RBI/CEPD/2025-26/382</span></div>
