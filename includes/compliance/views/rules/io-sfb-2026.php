...
<div class="doc">
  ...
  <main class="body-col">
    ...
    <section class="sec" id="penalised">
      ...
      <?php else : ?>
      <p>No action in our tracker cites a Small Finance Bank's Internal Ombudsman framework so far, the IO-related penalties this year landed on commercial banks and NBFCs. The obligation set is the same, which makes their cited failures the playbook of what supervisors check.</p>
      <?php endif; ?>
