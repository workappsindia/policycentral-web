<?php
/**
 * Decode: RBI (Non-Banking Financial Companies - Internal Ombudsman) Directions, 2026
 * /compliance/rules/io-nbfc-2026   (rbi_rule single)
 *
 * Verified against the RBI notification id=13274 (RBI/CEPD/2025-26/384),
 * 14 Jan 2026, issued under ss. 45L r/w 45M of the RBI Act. See
 * compliance-build/research/2026-io-directions-verified.md.
 * Obligations are described thematically, NO unverified 2026 clause numbers.
 */
defined('ABSPATH') || exit;

$rbi_url  = 'https://www.rbi.org.in/Scripts/BS_ViewMasDirections.aspx?id=13274';
...
<div class="container">
  <div class="rh-inner">
    <h1>RBI <span class="g-text">(NBFC - Internal Ombudsman)</span> Directions, 2026</h1>
    <p class="lede">The 2026 Direction requiring larger NBFCs to maintain an independent Internal Ombudsman and escalate every rejected customer complaint to it before the customer reaches the RBI Ombudsman. Issued under sections 45L read with 45M of the RBI Act, one of six entity-class Directions that replaced the 2023 Master Direction on 14 January 2026.</p>
    ...
    <?php pcc_breadcrumb(array(array('label' => 'Compliance Intelligence', 'url' => home_url('/compliance/')), array('label' => 'Rule Library', 'url' => home_url('/compliance/rules/')), array('label' => 'NBFC IO Directions, 2026'))); ?>
  </div>
</div>
</section>
  ...
  <main class="body-col">
    <div class="metabox">
      ...
      <div class="metabox-body">
        <div class="metabox-row"><span class="k">Instrument</span><span class="v">RBI/CEPD/2025-26/384</span></div>
        ...
        <div class="metabox-row"><span class="k">Power</span><span class="v">ss. 45L r/w 45M, RBI Act</span></div>
        <div class="metabox-row"><span class="k">Applies to</span><span class="v">Larger NBFCs (see scope)</span></div>
    ...
    <section class="sec" id="summary">
      <div class="tldr">
        ...
        <p>If a covered NBFC rejects a customer complaint, that rejection must be reviewed by an <strong>independent Internal Ombudsman inside the NBFC</strong> before the customer is told to approach the RBI Ombudsman, and the NBFC must be able to show the system, people and staff awareness to make that happen reliably.</p>
      </div>
      <p>On 14 January 2026 the RBI replaced its single 2023 Internal Ombudsman Master Direction with <strong>six entity-class-specific Directions</strong>. This one applies to NBFCs. It keeps the core architecture, auto-escalation of rejected complaints, binding reasoned decisions, Board oversight, while spelling out, in detail, which categories of NBFC are in and out of scope.</p>
    </section>

    <section class="sec" id="applies">
      <div class="sec-eyebrow"><span>Scope</span></div>
      <h2>Who it applies to</h2>
      <p>Applicability is measured as on 31 March 2025 and is the part most worth reading carefully, the exclusion list is long.</p>
      <ul class="applies">
        <li><span class="chk"><svg viewBox="0 0 12 12" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="2 6 5 9 10 3"/></svg></span><span><b>Deposit-taking NBFCs (NBFC-D)</b> with <b>10 or more branches</b>.</span></li>
        <li><span class="chk"><svg viewBox="0 0 12 12" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="2 6 5 9 10 3"/></svg></span><span><b>Non-deposit NBFCs (NBFC-ND)</b> with asset size <b>₹5,000 crore and above</b> and a <b>public customer interface</b>.</span></li>
        <li><span class="chk"><svg viewBox="0 0 12 12" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="2 6 5 9 10 3"/></svg></span><span><b>Excludes</b> Housing Finance Companies, Core Investment Companies, Infrastructure Debt Fund-NBFCs, NBFC-Infrastructure Finance Companies, Non-Operative Financial Holding Companies, Primary Dealers and Mortgage Guarantee Companies, and any NBFC under insolvency, liquidation or directions.</span></li>
        <li><span class="chk"><svg viewBox="0 0 12 12" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="2 6 5 9 10 3"/></svg></span><span>An NBFC meeting the criteria <b>after 31 March 2025</b> must comply within <b>six months</b>.</span></li>
      </ul>
      <div class="note-row">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>
        <span><b>HFCs are excluded</b>, a Housing Finance Company is not brought under this Direction by virtue of its size alone. ("CIC" here means a <i>Core Investment Company</i>, not a Credit Information Company.)</span>
      </div>
    </section>
    ...
    <section class="sec" id="obligations">
      ...
      <div class="obgroup">
        ...
        <div class="obgroup-body">
          <div class="obrow"><div class="otxt"><h4>An independent Internal Ombudsman</h4><p>An IO appointed for a fixed contractual term, independent of the NBFC, sitting at the apex of the grievance-redress mechanism and reporting functionally to the Board. A Deputy IO may be appointed where complaint volume warrants.</p></div></div>
        </div>
      </div>
      ...
      <div class="obgroup">
        ...
        <div class="obgroup-body">
          ...
          <div class="obrow"><div class="otxt"><h4>30-day final decision</h4><p>The final decision must reach the complainant within <b>30 days</b> of the NBFC first receiving the complaint.</p></div></div>
          <div class="obrow"><div class="otxt"><h4>Binding decisions &amp; the customer's next step</h4><p>The IO's decision binds the NBFC unless the competent authority formally disagrees through a narrow Board-level route. Where a complaint is still rejected after IO review, the NBFC must inform the customer of their right to approach the RBI Ombudsman.</p></div></div>
        </div>
      </div>
      ...
      <div class="obgroup">
        ...
        <div class="obgroup-body">
          <div class="obrow"><div class="otxt"><h4>Disseminate across all offices &amp; train</h4><p>Widely disseminate the IO guidelines among staff across <b>all branches and administrative offices</b> when communicating the appointment, and feed analysis of complaints handled by the IO into staff training.</p></div></div>
    ...
    <section class="sec" id="changed">
      ...
      <ul class="applies">
        <li><span class="chk"><svg viewBox="0 0 12 12" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="2 6 5 9 10 3"/></svg></span><span>The single 2023 Master Direction was <b>repealed</b> and split into <b>six entity-class Directions</b>; this is the NBFC one. Existing IO appointments continue under it.</span></li>
        <li><span class="chk"><svg viewBox="0 0 12 12" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="2 6 5 9 10 3"/></svg></span><span>The <b>excluded categories are spelled out</b>, HFCs, Core Investment Companies, IDF-NBFCs, NBFC-IFCs, NOFHCs, Primary Dealers and Mortgage Guarantee Companies are out of scope.</span></li>
    ...
    <section class="sec" id="penalised">
      ...
      <p>A recurring FY25-26 theme among NBFCs: rejected complaints not escalated to the IO in time, or no auto-escalation system at all. Each entry states only the reason cited in the RBI press release; where a penalty covered several issues, the amount is the total and isn't attributable to any single reason.</p>
      <div class="pen-grid">
        <?php echo pcc_render_penalised_for_rule('io-nbfc-2026'); ?>
      </div>
    ...
    <section class="sec" id="background">
      ...
      <p>The IO framework has been consolidated steadily. Knowing the lineage helps when older institutional documents still reference the repealed names.</p>
      <ul class="lineage">
        ...
        <li class="now"><span class="yr">14 Jan 2026</span><b>Six entity-class Directions, 2026</b>, this NBFC Direction is one of them.</li>
      </ul>
    </section>
    ...
    <div class="opcallout">
      ...
      <div class="opcallout-t"><h3>Knowing the rule is step one</h3><p>See how NBFCs distribute the IO SOP across every branch and prove who acknowledged it.</p></div>
    ...
    <section class="sec" id="source" style="margin-top:48px">
      <div class="srcbox">
        ...
        <div class="src-row"><span class="k">Title</span><span class="v">RBI (NBFC - Internal Ombudsman) Directions, 2026</span></div>
        <div class="src-row"><span class="k">Reference no.</span><span class="v">RBI/CEPD/2025-26/384</span></div>
