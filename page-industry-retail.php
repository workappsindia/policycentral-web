...
<div class="hero-grid container">
  <div class="hero-content">
    ...
    <p class="subtitle">Store circulars, pricing protocols, SOPs and vendor advisories, delivered to every outlet and partner supplier in the local language, with acknowledgement on record. Built for multi-outlet and specialty retail chains.</p>
    <div class="hero-btns">
    ...
    <div class="breadcrumb">
      ...
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="9 18 15 12 9 6"/></svg>
      <span style="color:var(--accent)">Retail</span>
    </div>
  </div>
